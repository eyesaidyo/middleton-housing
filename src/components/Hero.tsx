        ...
        <div className="flex-1 text-center md:text-left flex flex-col justify-center h-full">
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            ...
            <a
              ...
              className="bg-white text-middleton-green font-bold hover:bg-middleton-denim px-6 py-2.5 rounded-md text-sm transition-colors border-2 border-transparent hover:border-middleton-green"
            >
              Get Started
            </a>
          </div>
